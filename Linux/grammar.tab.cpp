...
union YYSTYPE
{
#line 19 "./lexical/ch.y"

    AST::BaseNode* ast;
    // struct symtab *symp;
    char* str;

#line 165 "./Linux/grammar.tab.cpp"
...
{
       0,    59,    59,    64,    67,    78,    81,    82,    86,    89,
      90,    92,    93,   101,   102,   103,   104,   107,   110,   111,
     114,   118,   121,   127,   130,   134,   138,   140,   143,   148,
     153,   156,   163,   169,   170,   173,   178,   183,   184,   185,
     190,   194,   200,   209,   216,   221,   224,   230,   237,   245,
     252,   259,   266,   271,   274,   277,   278,   284,   285,   294,
     300,   306,   312,   318,   324,   330,   336,   342,   348,   354,
     357,   362,   367,   372,   375,   378,   381,   388,   389,   392,
     393,   395,   398
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2:
#line 59 "./lexical/ch.y"
                          { 
        root = new BaseNode("code start!", AST::root);
        root->addChildNode((yyvsp[0].ast));
    }
#line 1634 "./Linux/grammar.tab.cpp"
    break;

  case 3:
#line 64 "./lexical/ch.y"
                                       { 
        (yyval.ast) = (yyvsp[0].ast);
    }
#line 1642 "./Linux/grammar.tab.cpp"
    break;

  case 4:
#line 67 "./lexical/ch.y"
                                            {
        if ((yyvsp[-1].ast) == NULL) {
            (yyval.ast) = (yyvsp[0].ast);
        } else {
...
#line 1657 "./Linux/grammar.tab.cpp"
    break;

  case 5:
#line 78 "./lexical/ch.y"
                                                              {
        (yyval.ast) = (yyvsp[-1].ast);
    }
#line 1665 "./Linux/grammar.tab.cpp"
    break;

  case 6:
#line 81 "./lexical/ch.y"
                    {}
#line 1671 "./Linux/grammar.tab.cpp"
    break;

  case 7:
#line 82 "./lexical/ch.y"
                                                   {
        (yyvsp[-1].ast)->addChildNode((yyvsp[0].ast));
        (yyval.ast) = (yyvsp[-1].ast);
    }
#line 1680 "./Linux/grammar.tab.cpp"
    break;

  case 8:
#line 86 "./lexical/ch.y"
                                     {
        (yyval.ast) = (yyvsp[-1].ast);
    }
...
#line 1739 "./Linux/grammar.tab.cpp"
    break;

  case 17:
#line 107 "./lexical/ch.y"
                                                            { (yyval.ast) = NULL; }
#line 1745 "./Linux/grammar.tab.cpp"
    break;

  case 18:
#line 110 "./lexical/ch.y"
                                            { (yyval.ast) = NULL; }
#line 1751 "./Linux/grammar.tab.cpp"
    break;
...
#line 1771 "./Linux/grammar.tab.cpp"
    break;
...
#line 121 "./lexical/ch.y"
        ...
        (yyval.ast) = new AST::DefineVarNode(s);
    }
#line 1781 "./Linux/grammar.tab.cpp"
    break;

  case 23:
#line 127 "./lexical/ch.y"
                                           { 
        (yyval.ast) = new AST::DefineFuncNode((yyvsp[-3].str));
    }
#line 1789 "./Linux/grammar.tab.cpp"
    break;
...
#line 1797 "./Linux/grammar.tab.cpp"
    break;
...
#line 1806 "./Linux/grammar.tab.cpp"
    break;

  case 26:
#line 138 "./lexical/ch.y"
                            { (yyval.ast) = (yyvsp[0].ast); }
...
#line 140 "./lexical/ch.y"
                                    {
        (yyval.ast) = new AST::DefineVarNode((yyvsp[-1].str));
    }
#line 1820 "./Linux/grammar.tab.cpp"
    break;

  case 28:
#line 143 "./lexical/ch.y"
                {}
...
#line 1854 "./Linux/grammar.tab.cpp"
    break;
...
#line 1894 "./Linux/grammar.tab.cpp"
    break;

  case 37:
#line 183 "./lexical/ch.y"
                       { (yyval.ast) =NULL; }
#line 1900 "./Linux/grammar.tab.cpp"
    break;
...
#line 1925 "./Linux/grammar.tab.cpp"
    break;
...
#line 1979 "./Linux/grammar.tab.cpp"
    break;
...
#line 2027 "./Linux/grammar.tab.cpp"
    break;
...
#line 2039 "./Linux/grammar.tab.cpp"
    break;
...
#line 2051 "./Linux/grammar.tab.cpp"
    break;
...
#line 2071 "./Linux/grammar.tab.cpp"
  ...
  case 55:
#line 277 "./lexical/ch.y"
                              { (yyval.ast) = (yyvsp[0].ast); }
#line 2077 "./Linux/grammar.tab.cpp"
    break;

  case 56:
#line 278 "./lexical/ch.y"
                                       {
        (yyvsp[-2].ast)->getFinalCousinNode()->addCousinNode((yyvsp[0].ast));
        (yyval.ast) = (yyvsp[-2].ast);
    }
#line 2086 "./Linux/grammar.tab.cpp"
  ...
  case 57:
#line 284 "./lexical/ch.y"
                               { (yyval.ast) = (yyvsp[0].ast); }
#line 2092 "./Linux/grammar.tab.cpp"
    break;
...
#line 2135 "./Linux/grammar.tab.cpp"
    break;

  case 62:
#line 312 "./lexical/ch.y"
                                      {
...
#line 2146 "./Linux/grammar.tab.cpp"
    break;

  case 63:
#line 318 "./lexical/ch.y"
                                    {
            BaseNode* temp = new AST::OperatorNode("+");
            temp->addChildNode((yyvsp[-2].ast));
            (yyvsp[-2].ast)->addCousinNode((yyvsp[0].ast));
...
#line 2157 "./Linux/grammar.tab.cpp"
    break;
...
#line 2179 "./Linux/grammar.tab.cpp"
    break;
...
#line 2201 "./Linux/grammar.tab.cpp"
    break;
...
#line 2212 "./Linux/grammar.tab.cpp"
    break;
...
#line 2230 "./Linux/grammar.tab.cpp"
    break;

  case 71:
#line 362 "./lexical/ch.y"
                         {
            BaseNode* temp = new AST::OperatorNode("!");
            temp->addChildNode((yyvsp[0].ast));
            (yyval.ast) = temp;
...
#line 2286 "./Linux/grammar.tab.cpp"
    break;
...
#line 2300 "./Linux/grammar.tab.cpp"
    break;

  case 79:
#line 392 "./lexical/ch.y"
                 {}
#line 2306 "./Linux/grammar.tab.cpp"
    break;
