...
union YYSTYPE
{
#line 23 "./lexical/ch.y"

    AST::BaseNode* ast;
    // struct symtab *symp;
    char* str;

#line 169 "./Linux/grammar.tab.cpp"
...
{
       0,    65,    65,    70,    73,    84,    91,    92,    98,   103,
     104,   106,   107,   112,   113,   118,   119,   130,   131,   132,
     133,   136,   146,   147,   152,   159,   162,   171,   174,   178,
     182,   184,   189,   198,   203,   206,   213,   217,   218,   221,
     226,   231,   236,   237,   242,   246,   253,   264,   270,   275,
     280,   285,   290,   295,   300,   305,   310,   315,   325,   328,
     329,   335,   336,   345,   351,   357,   363,   369,   375,   381,
     387,   393,   399,   405,   408,   413,   418,   424,   429,   432,
     435,   438,   445,   453,   456,   457,   459,   462
};
#endif
...
#line 1653 "./Linux/grammar.tab.cpp"
    break;

  case 3:
#line 70 "./lexical/ch.y"
                                       { 
...
#line 1676 "./Linux/grammar.tab.cpp"
    break;
...
#line 1688 "./Linux/grammar.tab.cpp"
    break;

  case 6:
#line 91 "./lexical/ch.y"
                    {}
#line 1694 "./Linux/grammar.tab.cpp"
    break;
...
#line 1705 "./Linux/grammar.tab.cpp"
    break;

  case 8:
#line 98 "./lexical/ch.y"
                                     {
        AST::DefineFuncNode* tmp = (AST::DefineFuncNode*) (yyvsp[-1].ast);
        tmp->setReturnSymbolType((yyvsp[-2].str));
        (yyval.ast) = tmp;
    }
#line 1715 "./Linux/grammar.tab.cpp"
    break;

  case 9:
#line 103 "./lexical/ch.y"
                           { (yyval.ast) = (yyvsp[-1].ast);}
#line 1721 "./Linux/grammar.tab.cpp"
    break;

  case 10:
#line 104 "./lexical/ch.y"
                { yyerrok; (yyval.ast) = NULL;}
#line 1727 "./Linux/grammar.tab.cpp"
    break;
...
#line 1742 "./Linux/grammar.tab.cpp"
    break;
...
#line 1757 "./Linux/grammar.tab.cpp"
    break;

  case 15:
#line 118 "./lexical/ch.y"
                                   { (yyval.ast) = (yyvsp[0].ast); }
#line 1763 "./Linux/grammar.tab.cpp"
    break;
...
#line 1775 "./Linux/grammar.tab.cpp"
    break;

  case 17:
#line 130 "./lexical/ch.y"
               { (yyval.str) = strdup("int"); }
#line 1781 "./Linux/grammar.tab.cpp"
    break;

  case 18:
#line 131 "./lexical/ch.y"
           { (yyval.str) = strdup("void"); }
#line 1787 "./Linux/grammar.tab.cpp"
    break;

  case 19:
#line 132 "./lexical/ch.y"
              { (yyval.str) = strdup("int ptr"); }
#line 1793 "./Linux/grammar.tab.cpp"
    break;
...
#line 147 "./lexical/ch.y"
        ...
        (yyvsp[-1].ast)->getFinalCousinNode()->addCousinNode((yyvsp[0].ast)); 
        (yyval.ast) = (yyvsp[-1].ast); }
#line 1826 "./Linux/grammar.tab.cpp"
    break;
...
#line 1835 "./Linux/grammar.tab.cpp"
  ...
  case 25:
#line 159 "./lexical/ch.y"
                      {
        (yyval.ast) = new AST::DefineVarNode((yyvsp[0].str));
    }
#line 1843 "./Linux/grammar.tab.cpp"
    break;
...
#line 1856 "./Linux/grammar.tab.cpp"
    break;

  case 27:
#line 171 "./lexical/ch.y"
                                           { 
        (yyval.ast) = new AST::DefineFuncNode((yyvsp[-3].str), (yyvsp[-1].ast));
    }
#line 1864 "./Linux/grammar.tab.cpp"
    break;

  case 28:
#line 174 "./lexical/ch.y"
                 {
        (yyval.ast) = new AST::DefineFuncNode((yyvsp[-2].str));
    }
#line 1872 "./Linux/grammar.tab.cpp"
    break;

  case 29:
#line 178 "./lexical/ch.y"
                                                         {
        (yyvsp[-2].ast)->getFinalCousinNode()->addCousinNode((yyvsp[0].ast));
        (yyval.ast) = (yyvsp[-2].ast);
    }
#line 1881 "./Linux/grammar.tab.cpp"
  ...
  case 30:
#line 182 "./lexical/ch.y"
                            { (yyval.ast) = (yyvsp[0].ast); }
#line 1887 "./Linux/grammar.tab.cpp"
    break;
...
#line 1897 "./Linux/grammar.tab.cpp"
    break;

  case 32:
#line 189 "./lexical/ch.y"
                {
        AST::DefineVarNode* tmp = new AST::DefineVarNode("");
        tmp->setAllSymbolType((yyvsp[0].str));
        (yyval.ast) = tmp;
    }
#line 1907 "./Linux/grammar.tab.cpp"
    break;
...
#line 1917 "./Linux/grammar.tab.cpp"
    break;

  case 34:
#line 203 "./lexical/ch.y"
                { yyerrok; }
#line 1923 "./Linux/grammar.tab.cpp"
    break;

  case 35:
#line 206 "./lexical/ch.y"
                                           {
        if ((yyvsp[-1].ast) == NULL) {
            (yyval.ast) = (yyvsp[0].ast);
        } else {
...
#line 1935 "./Linux/grammar.tab.cpp"
    break;

  case 36:
#line 213 "./lexical/ch.y"
      { (yyval.ast) = NULL; }
#line 1941 "./Linux/grammar.tab.cpp"
    break;

  case 37:
#line 217 "./lexical/ch.y"
                            { (yyval.ast) = (yyvsp[0].ast); }
#line 1947 "./Linux/grammar.tab.cpp"
    break;

  case 38:
#line 218 "./lexical/ch.y"
                 { (yyval.ast) = (yyvsp[0].ast); }
#line 1953 "./Linux/grammar.tab.cpp"
    break;

  case 39:
#line 221 "./lexical/ch.y"
                          { 
        BaseNode* temp = new AST::StatementNode(AST::expression);
        temp->addChildNode((yyvsp[-1].ast));
        (yyval.ast) = temp;
    }
#line 1963 "./Linux/grammar.tab.cpp"
    break;

  case 40:
#line 226 "./lexical/ch.y"
                     { 
        BaseNode* temp = new AST::StatementNode(AST::defination);
        temp->addChildNode((yyvsp[-1].ast));
        (yyval.ast) = temp;
    }
#line 1973 "./Linux/grammar.tab.cpp"
    break;

  case 41:
#line 231 "./lexical/ch.y"
                       { 
        BaseNode* temp = new AST::StatementNode(AST::defination);
        BaseNode* struct_def = new AST::DefineVarNode((yyvsp[-2].str),(yyvsp[-1].str));
        temp->addChildNode(struct_def);
        (yyval.ast) = temp; }
#line 1983 "./Linux/grammar.tab.cpp"
    break;

  case 42:
#line 236 "./lexical/ch.y"
                         { (yyval.ast)=(yyvsp[0].ast);}
#line 1989 "./Linux/grammar.tab.cpp"
    break;
...
#line 1999 "./Linux/grammar.tab.cpp"
    break;

  case 44:
#line 242 "./lexical/ch.y"
                 {
        BaseNode* temp = new AST::StatementNode(AST::return_stmt);
        (yyval.ast) = temp;
    }
#line 2008 "./Linux/grammar.tab.cpp"
    break;

  case 45:
#line 246 "./lexical/ch.y"
                                      {  // ok
...
#line 2020 "./Linux/grammar.tab.cpp"
    break;

  case 46:
#line 253 "./lexical/ch.y"
                                                                          {
        AST::SelectNode* temp = new AST::SelectNode(AST::if_stmt);
...
#line 2056 "./Linux/grammar.tab.cpp"
    break;

  case 49:
#line 275 "./lexical/ch.y"
                                                   {
...
#line 2076 "./Linux/grammar.tab.cpp"
    break;
...
#line 2086 "./Linux/grammar.tab.cpp"
    break;
...
#line 2096 "./Linux/grammar.tab.cpp"
    break;
...
#line 2106 "./Linux/grammar.tab.cpp"
    break;
...
#line 2116 "./Linux/grammar.tab.cpp"
    break;

  case 55:
#line 305 "./lexical/ch.y"
                                                          { //OK
        BaseNode* temp = new AST::LoopNode("", AST::for_loop, (yyvsp[-4].ast), NULL, (yyvsp[-2].ast));
        temp->addChildNode((yyvsp[0].ast));
        (yyval.ast) = temp;
    }
#line 2126 "./Linux/grammar.tab.cpp"
    break;
...
#line 2147 "./Linux/grammar.tab.cpp"
    break;

  case 58:
#line 325 "./lexical/ch.y"
                { yyerrok; }
#line 2153 "./Linux/grammar.tab.cpp"
    break;

  case 59:
#line 328 "./lexical/ch.y"
                              { (yyval.ast) = (yyvsp[0].ast); }
#line 2159 "./Linux/grammar.tab.cpp"
    break;
...
#line 2168 "./Linux/grammar.tab.cpp"
    break;
...
#line 2239 "./Linux/grammar.tab.cpp"
    break;

  case 68:
#line 375 "./lexical/ch.y"
                                    {
...
#line 2250 "./Linux/grammar.tab.cpp"
    break;

  case 69:
#line 381 "./lexical/ch.y"
                                    {
...
#line 2261 "./Linux/grammar.tab.cpp"
    break;

  case 70:
#line 387 "./lexical/ch.y"
                                    {
...
#line 2272 "./Linux/grammar.tab.cpp"
    break;

  case 71:
#line 393 "./lexical/ch.y"
                                    {
...
#line 2294 "./Linux/grammar.tab.cpp"
    break;
...
#line 2312 "./Linux/grammar.tab.cpp"
    break;
...
#line 2333 "./Linux/grammar.tab.cpp"
    break;

  case 77:
#line 424 "./lexical/ch.y"
                                              {
            AST::CallFuncNode* temp = new AST::CallFuncNode((yyvsp[-3].str));
            temp->setVarList((yyvsp[-1].ast));
            (yyval.ast) = temp;
        }
#line 2343 "./Linux/grammar.tab.cpp"
    break;

  case 78:
#line 429 "./lexical/ch.y"
                     {
            (yyval.ast) = new AST::CallFuncNode((yyvsp[-2].str));
        }
#line 2351 "./Linux/grammar.tab.cpp"
    break;

  case 79:
#line 432 "./lexical/ch.y"
                                        {
            (yyval.ast) = NULL;
        }
#line 2359 "./Linux/grammar.tab.cpp"
    break;

  case 80:
#line 435 "./lexical/ch.y"
             {
            (yyval.ast) = new AST::AssignVarNode((yyvsp[0].str));
        }
#line 2367 "./Linux/grammar.tab.cpp"
    break;
...
#line 2379 "./Linux/grammar.tab.cpp"
    break;

  case 82:
#line 445 "./lexical/ch.y"
                          {
...
#line 2392 "./Linux/grammar.tab.cpp"
    break;

  case 83:
#line 453 "./lexical/ch.y"
              {
            (yyval.ast) = new AST::LiteralNode((yyvsp[0].str));
        }
#line 2400 "./Linux/grammar.tab.cpp"
    break;

  case 84:
#line 456 "./lexical/ch.y"
                 {}
#line 2406 "./Linux/grammar.tab.cpp"
    break;

  case 85:
#line 457 "./lexical/ch.y"
                    {yyerrok;}
#line 2412 "./Linux/grammar.tab.cpp"
    break;

  case 86:
#line 459 "./lexical/ch.y"
                                     {
            (yyval.ast) = (yyvsp[0].ast);
        }
...
#line 2433 "./Linux/grammar.tab.cpp"
