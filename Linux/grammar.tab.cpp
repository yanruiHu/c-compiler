...
#line 180 "./Linux/grammar.tab.cpp"
...
{
       0,    58,    58,    63,    66,    77,    80,    81,    85,    88,
      89,    91,    92,   100,   101,   102,   103,   106,   109,   110,
     113,   117,   123,   133,   142,   152,   156,   158,   167,   172,
     177,   180,   187,   193,   194,   197,   202,   207,   208,   209,
     214,   218,   224,   233,   240,   245,   248,   254,   261,   269,
     276,   283,   290,   295,   298,   301,   302,   308,   309,   317,
     324,   330,   336,   348,   354,   360,   366,   372,   378,   384,
     387,   392,   397,   408,   417,   420,   423,   436,   437,   446,
     447,   449,   452
};
#endif
...
{
  "$end", "error", "$undefined", "ASSIGNOP", "OR", "AND", "RELOP", "DEC",
  "ADD", "MUL", "DIV", "MOD", "POWER", "NOT", "LB", "RB", "MLB", "MRB",
  "LOWER_THAN_ELSE", "ERRID", "ID", "INT", "VOID", "COM", "SEM", "STRUCT",
  "IF", "ELSE", "WHILE", "FOR", "CONTINUE", "RETURN", "ERRORCHAR",
  "GETMEMBER", "BLB", "BRB", "'.'", "$accept", "program",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2:
#line 58 "./lexical/ch.y"
                          { 
        root = new BaseNode();
        root->addChildNode((yyvsp[0].ast));
    }
#line 1651 "./Linux/grammar.tab.cpp"
    break;

  case 3:
#line 63 "./lexical/ch.y"
                                       { 
        (yyval.ast) = (yyvsp[0].ast);
    }
#line 1659 "./Linux/grammar.tab.cpp"
    break;
...
#line 1674 "./Linux/grammar.tab.cpp"
  ...
  case 5:
#line 77 "./lexical/ch.y"
                                                              {
            (yyval.ast) = (yyvsp[-1].ast);
    }
#line 1682 "./Linux/grammar.tab.cpp"
    break;
...
#line 88 "./lexical/ch.y"
                           {(yyval.ast) = (yyvsp[-1].ast);}
#line 1711 "./Linux/grammar.tab.cpp"
    break;

  case 10:
#line 89 "./lexical/ch.y"
                { yyerrok; (yyval.ast) = NULL;}
#line 1717 "./Linux/grammar.tab.cpp"
    break;

  case 11:
#line 91 "./lexical/ch.y"
                                             { (yyval.ast) = (yyvsp[0].ast); }
#line 1723 "./Linux/grammar.tab.cpp"
    break;
...
#line 1744 "./Linux/grammar.tab.cpp"
    break;

  case 15:
#line 102 "./lexical/ch.y"
              { (yyval.str) = strdup("int ptr"); }
#line 1750 "./Linux/grammar.tab.cpp"
    break;

  case 16:
#line 103 "./lexical/ch.y"
               { (yyval.str) = strdup("void ptr"); }
#line 1756 "./Linux/grammar.tab.cpp"
    break;

  case 17:
#line 106 "./lexical/ch.y"
                                                            { (yyval.ast) = NULL; }
#line 1762 "./Linux/grammar.tab.cpp"
    break;

  case 18:
#line 109 "./lexical/ch.y"
                                            { (yyval.ast) = NULL; }
#line 1768 "./Linux/grammar.tab.cpp"
    break;

  case 19:
#line 110 "./lexical/ch.y"
                                                { (yyval.ast) = NULL; }
#line 1774 "./Linux/grammar.tab.cpp"
    break;
...
#line 117 "./lexical/ch.y"
        ...
        s = s + (yyvsp[0].str);
        (yyval.ast) = new BaseNode(strdup(s.c_str()));
        // $$ = new BaseNode($1);
    }
...
#line 1833 "./Linux/grammar.tab.cpp"
    break;
...
#line 1842 "./Linux/grammar.tab.cpp"
  ...
  case 26:
#line 156 "./lexical/ch.y"
                            { (yyval.ast) = (yyvsp[0].ast); }
#line 1848 "./Linux/grammar.tab.cpp"
    break;

  case 27:
#line 158 "./lexical/ch.y"
                                    {
        // char* s = "";
...
#line 1862 "./Linux/grammar.tab.cpp"
    break;

  case 28:
#line 167 "./lexical/ch.y"
                {}
#line 1868 "./Linux/grammar.tab.cpp"
    break;
...
#line 1878 "./Linux/grammar.tab.cpp"
    break;

  case 30:
#line 177 "./lexical/ch.y"
                { yyerrok; }
#line 1884 "./Linux/grammar.tab.cpp"
    break;
...
#line 1896 "./Linux/grammar.tab.cpp"
    break;
...
#line 1904 "./Linux/grammar.tab.cpp"
    break;

  case 33:
#line 193 "./lexical/ch.y"
                            { (yyval.ast) = (yyvsp[0].ast); }
#line 1910 "./Linux/grammar.tab.cpp"
    break;
...
#line 1926 "./Linux/grammar.tab.cpp"
    break;

  case 36:
#line 202 "./lexical/ch.y"
                     { 
...
#line 1948 "./Linux/grammar.tab.cpp"
  ...
  case 39:
#line 209 "./lexical/ch.y"
                            {
        BaseNode* temp = new BaseNode("return statement");
        temp->addChildNode((yyvsp[-1].ast));
        (yyval.ast) = temp;
    }
#line 1958 "./Linux/grammar.tab.cpp"
    break;
...
#line 1978 "./Linux/grammar.tab.cpp"
    break;

  case 42:
#line 224 "./lexical/ch.y"
                                                                        {
        BaseNode* temp = new BaseNode("select statement(if)");
...
#line 1992 "./Linux/grammar.tab.cpp"
    break;

  case 43:
#line 233 "./lexical/ch.y"
                                       { //ok
...
#line 2003 "./Linux/grammar.tab.cpp"
    break;

  case 44:
#line 240 "./lexical/ch.y"
                                 { //ok
        BaseNode* temp = new BaseNode("loop statement(for)");
        temp->addChildNode((yyvsp[0].ast));
        (yyval.ast) = temp;
    }
#line 2013 "./Linux/grammar.tab.cpp"
    break;
...
#line 2032 "./Linux/grammar.tab.cpp"
    break;
...
#line 2044 "./Linux/grammar.tab.cpp"
    break;

  case 48:
#line 261 "./lexical/ch.y"
                                                                        { //OK
        BaseNode* temp = new BaseNode("loop statement(for)");
...
#line 2128 "./Linux/grammar.tab.cpp"
    break;

  case 57:
#line 308 "./lexical/ch.y"
                               { (yyval.ast) = (yyvsp[0].ast); }
#line 2134 "./Linux/grammar.tab.cpp"
    break;

  case 58:
#line 309 "./lexical/ch.y"
                                            {
        (yyvsp[-2].ast)->addChildNode((yyvsp[0].ast));
        (yyval.ast) = (yyvsp[-2].ast);
    }
#line 2143 "./Linux/grammar.tab.cpp"
    break;
...
#line 2155 "./Linux/grammar.tab.cpp"
    break;

  case 60:
#line 324 "./lexical/ch.y"
                                    {
...
#line 2166 "./Linux/grammar.tab.cpp"
    break;
...
#line 2177 "./Linux/grammar.tab.cpp"
    break;
...
#line 2205 "./Linux/grammar.tab.cpp"
    break;

  case 64:
#line 354 "./lexical/ch.y"
                                    {
            BaseNode* temp = new BaseNode("operator: -", op);
            temp->addChildNode((yyvsp[-2].ast));
            (yyvsp[-2].ast)->addCousinNode((yyvsp[0].ast));
...
#line 2216 "./Linux/grammar.tab.cpp"
    break;
...
#line 2227 "./Linux/grammar.tab.cpp"
    break;
...
#line 2238 "./Linux/grammar.tab.cpp"
    break;
...
#line 2260 "./Linux/grammar.tab.cpp"
    break;
...
#line 2268 "./Linux/grammar.tab.cpp"
    break;
...
#line 2278 "./Linux/grammar.tab.cpp"
    break;
...
#line 2288 "./Linux/grammar.tab.cpp"
    break;
...
#line 2304 "./Linux/grammar.tab.cpp"
    break;
...
#line 2318 "./Linux/grammar.tab.cpp"
    break;
...
#line 2326 "./Linux/grammar.tab.cpp"
    break;
...
#line 2334 "./Linux/grammar.tab.cpp"
    break;

  case 76:
#line 423 "./lexical/ch.y"
                                {
...
#line 2352 "./Linux/grammar.tab.cpp"
  ...
  case 77:
#line 436 "./lexical/ch.y"
                    {}
#line 2358 "./Linux/grammar.tab.cpp"
    break;
...
#line 2372 "./Linux/grammar.tab.cpp"
    break;

  case 79:
#line 446 "./lexical/ch.y"
                 {}
#line 2378 "./Linux/grammar.tab.cpp"
    break;

  case 80:
#line 447 "./lexical/ch.y"
                   {yyerrok;}
#line 2384 "./Linux/grammar.tab.cpp"
    break;

  case 81:
#line 449 "./lexical/ch.y"
                                     {
            (yyval.ast) = (yyvsp[0].ast);
        }
...
#line 2405 "./Linux/grammar.tab.cpp"
